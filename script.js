...
const quizInfo = {
  devnetAssociate: {
    ...
    desc: "API基礎、Python、自動化、Ciscoプラットフォーム、ネットワーク基礎、セキュリティ、DevOps"
  },
  devnetProfessional: {
    title: "Cisco DevNet Professional",
    desc: "高度な自動化設計、API連携、CI/CD、インフラ自動化、セキュア開発、運用監視"
  },
  extremeAssociate: {
    title: "Extreme Networks Associate",
    desc: "ExtremeCloud IQ、スイッチング基礎、VLAN、STP、PoE、無線、基本運用"
  },
  extremeProfessional: {
    title: "Extreme Networks Professional",
    desc: "高度なキャンパス設計、Fabric、ルーティング、認証、無線最適化、監視、冗長化"
  }
};
...
if (type === "all") {
  document.title = "Cisco DevNet・Extreme Networks資格クイズ";
  pageTitle.textContent = "Cisco DevNet・Extreme Networks資格クイズ";
  pageDesc.textContent = "4カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.devnetAssociate;
